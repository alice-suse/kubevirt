...
func init() {
	...
	flag.StringVar(&PreviousUtilityRegistry, "previous-utility-container-registry", KubeVirtRepoPrefix, "Set registry of the utility containers to test updating from")
